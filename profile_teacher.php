...
<html lang="en">
 ...
 .position {
  ...
  align-self: center;
  justify-self: center;
  padding-bottom: 18px; /* space between text and underline */
  margin-bottom: 2rem; /* space below the underline */
  color: #0a4d3c;
  font-weight: 700;
...
.position::after {
  ...
  border-radius: 3px;
  box-shadow: 0 2px 8px rgba(10, 77, 60, 0.25);
}
...
<?php
    ...
    if (isset($_GET['name'])){
      $name=$_GET['name'];
      $dept=$_GET['dept'];
      $sql="select* from teacher where name='".$name."' and dept='".$dept."';";
    ...
    <main class="profile-container">
      <div class="position"><h2><?php echo $row['position'];?></h2></div>
      <div class="profile-header">
        ...
        <div class="profile-info">
          ...
          <p class="dept"><?php echo $row['dept'];?></p>
          <p class="dept"><?php echo $row['faculty'];?></p>
          ...
          <div class="social-links-main">
            ...
            <a href=<?php echo "'".$row['rg']."'";?> target="_blank"><i class="fa-brands fa-researchgate"></i></a>
            <a href=<?php echo "'".$row['gs']."'";?> target="_blank"><i class="fa-solid fa-graduation-cap"></i></a>
            <a href=<?php echo "'".$row['oi']."'";?> target="_blank"><i class="fa-brands fa-orcid"></i></a>
          </div>
        </div>
      </div>
    </main>
